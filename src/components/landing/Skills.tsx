...
const skillCards = [
  ...
  },
  {
    ...
    tone: 'from-[#ffffff]/45 to-transparent dark:from-slate-900/55',
    titleClass: 'text-[#51315c] dark:text-slate-50',
    bodyClass: 'text-[#614b6a] dark:text-slate-200',
  },
];
  ...
  return (
    <section className="px-5 pb-12 pt-16 sm:px-8 lg:px-12 lg:pt-20">
      <div className="mx-auto max-w-[1360px]">
        ...
        <p className="text-center text-[1rem] text-[#596898] dark:text-slate-300 sm:text-[1.08rem]">
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          {skillCards.map((card, index) => (
            <article
              key={card.title}
              className={`group relative overflow-hidden rounded-[30px] border border-white/60 shadow-[0_20px_60px_rgba(74,73,140,0.14)] dark:border-slate-700/70 dark:shadow-[0_20px_60px_rgba(0,0,0,0.26)] ${
            ...
            >
              <div className={`relative aspect-[353/210] ${index === skillCards.length - 1 ? 'md:aspect-[620/270] xl:aspect-[420/240]' : 'md:aspect-[420/255] xl:aspect-[420/240]'}`}>
                ...
                <div className="absolute inset-x-0 bottom-0 p-5 md:p-6">
                  <div className="rounded-[24px] border border-white/20 bg-white/10 p-5 backdrop-blur-sm dark:border-slate-700/70 dark:bg-slate-950/42">
