    ...
    <aside className="lg:sticky lg:top-6 lg:h-[calc(100vh-48px)]">
      <div
        className={cn(
          ...
          isAdmin
            ? 'border border-[#d9def8] bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(246,243,255,0.92))] shadow-[0_24px_60px_rgba(74,73,140,0.12)]'
            : isTeacher
              ? 'border border-[#d9def8] bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(245,246,255,0.92))] shadow-[0_24px_60px_rgba(74,73,140,0.12)]'
              : isStudent
                ? 'border border-[#d9def8] bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(246,241,255,0.92))] shadow-[0_24px_60px_rgba(74,73,140,0.12)]'
      ...
      >
        ...
        <div className="hidden items-center gap-3 px-3 py-2">
          ...
          <div className="flex flex-col">
            <span className={cn('text-sm', isAdmin ? 'text-[#6d79a5]' : isTeacher ? 'text-[#6d79a5]' : isStudent ? 'text-[#8a6f9f]' : 'text-slate-400')}>Plataforma</span>
            <span className={cn('text-base font-semibold', isAdmin ? 'text-[#22347e]' : isTeacher ? 'text-[#22347e]' : isStudent ? 'text-[#22347e]' : 'text-white')}>Escreva Mais</span>
          </div>
        </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active
                    ? isAdmin
                      ? 'border border-[#cfd6ff] bg-[linear-gradient(135deg,#edf1ff_0%,#fff3ea_100%)] text-[#3141bf]'
                      : isTeacher
                        ? 'border border-[#cfd6ff] bg-[#edf1ff] text-[#3141bf]'
                        : isStudent
                          ? 'border border-[#ffd9cb] bg-[linear-gradient(135deg,#fff1eb_0%,#ffe3ef_100%)] text-[#cf5b34]'
                          : 'border border-indigo-500/40 bg-indigo-500/20 text-indigo-100'
                    : isAdmin
                      ? 'text-[#51608f] hover:bg-[#f6f1ff] hover:text-[#22347e]'
                      : isTeacher
                        ? 'text-[#51608f] hover:bg-[#f2f5ff] hover:text-[#22347e]'
                        : isStudent
                          ? 'text-[#6e628e] hover:bg-[#f7efff] hover:text-[#22347e]'
        ...
        <div
          className={cn(
            ...
            isAdmin
              ? 'border border-[#dde3fb] bg-white/80 text-[#51608f]'
              : isTeacher
                ? 'border border-[#dde3fb] bg-white/80 text-[#51608f]'
                : isStudent
                  ? 'border border-[#eadcf8] bg-white/80 text-[#6e628e]'
                  : 'border border-slate-800/70 bg-slate-900/70 text-slate-300',
          )}
        >
          <p className={cn('font-semibold', isAdmin ? 'text-[#22347e]' : isTeacher ? 'text-[#22347e]' : isStudent ? 'text-[#22347e]' : 'text-white')}>Dica rápida</p>
          <p className={cn('mt-1 text-xs', isAdmin ? 'text-[#6d79a5]' : isTeacher ? 'text-[#6d79a5]' : isStudent ? 'text-[#8a6f9f]' : 'text-slate-400')}>
            {isAdmin
        ...
        <div className="mt-4 lg:mt-6">
          <Button
            ...
            className={cn(
              ...
              isAdmin &&
                'border-[#d9def8] bg-[linear-gradient(135deg,#ffffff_0%,#eef2ff_100%)] text-[#3141bf] hover:border-[#bcc8ff] hover:text-[#22347e]',
              isTeacher &&
                'border-[#d9def8] bg-[linear-gradient(135deg,#ffffff_0%,#edf2ff_100%)] text-[#3141bf] hover:border-[#bcc8ff] hover:text-[#22347e]',
              isStudent &&
