    ...
    >
      ...
      <section className="rounded-[30px] border border-[#dbe1fb] bg-[linear-gradient(135deg,#fbfcff_0%,#fff4ee_100%)] p-6 shadow-[0_20px_54px_rgba(74,73,140,0.08)] dark:border-slate-700/70 dark:bg-[linear-gradient(135deg,rgba(15,23,42,0.96),rgba(48,29,41,0.9))] dark:shadow-[0_20px_54px_rgba(0,0,0,0.24)] sm:p-7">
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded-[24px] border border-[#e4e8f7] bg-white/82 p-5 dark:border-slate-700 dark:bg-slate-900/72">
            <div className="flex items-center gap-3">
              <Wrench className="h-5 w-5 text-[#4350c9] dark:text-indigo-300" />
              <h2 className="text-lg font-bold tracking-[-0.03em] text-slate-900 dark:text-slate-50">
          ...
          <div className="rounded-[24px] border border-[#ffd9cb] bg-[linear-gradient(135deg,rgba(255,244,238,0.96),rgba(255,251,247,0.92))] p-5 dark:border-slate-700 dark:bg-[linear-gradient(135deg,rgba(52,29,26,0.9),rgba(17,24,39,0.92))]">
            <div className="flex items-center gap-3">
              <XCircle className="h-5 w-5 text-[#cf5b34] dark:text-orange-300" />
              <h2 className="text-lg font-bold tracking-[-0.03em] text-slate-900 dark:text-slate-50">
        ...
        <div className="mt-6 space-y-4 text-[1rem] leading-8 text-slate-700 dark:text-slate-300">
          <p>
